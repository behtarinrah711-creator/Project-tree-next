...
export function makeProject(name,schemaVersion=8,id=uid()){
  return {id,name,type:'project',settings:{stageMode:'base'},tasks:[],contacts:[],activityTemplates:[],contractTemplates:[],contracts:[],contractStatusReports:[],completedOpen:false,archived:false,trashed:false,schemaVersion};
}
