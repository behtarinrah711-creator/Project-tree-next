...
import {
  ...
  createMember, normalizeMobile, permissionModules,
...
test('member creation normalizes mobile and fills every registered permission',()=>{
  const member=createMember({mobile:'+98 912 345 6789',role:'accountant',permissions:{dashboard:'view'}},{registry:registry(),now:()=>10,random:()=>0.5});
  ...
  assert.deepEqual(member.permissions,{dashboard:'view',planning:'none'});
